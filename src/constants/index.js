export const mainComplains = [
  ...
  },
  {
    ...
    text: "Coceira intensa, ressecamento e inflamação da pele, que causam desconforto constante.",
  },
  {
    title: "Queda de Cabelo",
    text: "Perda de cabelo excessiva, levando a preocupações estéticas e de saúde.",
  },
  {
    title: "Câncer de Pele",
    text: "Lesões suspeitas ou diagnosticadas que necessitam de avaliação e possível remoção cirúrgica.",
  },
  {
  ...
  },
  {
    ...
    text: "Erupções cutâneas, vermelhidão e irritação que causam desconforto e preocupação.",
  },
  {
    title: "Cicatrizes",
